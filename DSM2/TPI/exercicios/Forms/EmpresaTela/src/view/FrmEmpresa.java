...
public class FrmEmpresa extends javax.swing.JFrame {
    ...
    private void jtbTabelaEmpresaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbTabelaEmpresaMouseClicked
        ...
        txtCnpj.setText(jtbTabelaEmpresa.getValueAt(linhaSelecionada, 0).toString());
        txtEmpresa.setText(jtbTabelaEmpresa.getValueAt(linhaSelecionada, 1).toString());
        txtEndereco.setText(jtbTabelaEmpresa.getValueAt(linhaSelecionada, 2).toString());

    }//GEN-LAST:event_jtbTabelaEmpresaMouseClicked

    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        // TODO add your handling code here:
        empresa.setCnpj(Integer.parseInt(txtCnpj.getText()));
        empresa.setNomeEmpresa(txtEmpresa.getText());
