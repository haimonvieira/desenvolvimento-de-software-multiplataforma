...
public class Conexao {
    ...
    final private String url = "jdbc:mysql://127.0.0.1/consultausuario";
    ...
    public boolean conecta() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Driver nao localizado: " + Driver);
            result = false;
        } catch (SQLException Fonte) {
            JOptionPane.showMessageDialog(null,
                    "Erro na conexão com a fonte de dados: " + Fonte);
            result = false;
        }
        return result;
    }
...
//chamada do metodo conecta para abrir a conexão com o db
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Driver não encontrado: " + sqle.getMessage());
        }
    }
    ...
    public ResultSet RetornarResultset(String sql) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Erro ao retornar resultset: " + e.getMessage());
        }
        return resultSet;
    }
}
