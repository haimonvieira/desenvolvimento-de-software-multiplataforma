...
public class FrmPaciente extends javax.swing.JFrame {
    ...
    public void consultar() {
        ...
        tabela = paciente.consultar();

        DefaultTableModel modelo = (DefaultTableModel) jtbTabelaPaciente.getModel();
        modelo.setNumRows(0);
    ...
    private void initComponents() {
        ...
        jtbTabelaPaciente = new javax.swing.JTable();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtNomePaciente, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
        ...
        jtbTabelaPaciente.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Código Paciente", "Nome Paciente", "Endereço", "Complemento", "RG", "CPF", "Data nascimento"
            }
        ));
        jtbTabelaPaciente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtbTabelaPacienteMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtbTabelaPaciente);
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        paciente.setCodigo(Integer.parseInt(txtCodigoPaciente.getText()));
    ...
    private void jtbTabelaPacienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbTabelaPacienteMouseClicked
        // TODO add your handling code here:
        //para pegar o numero da linha selecionada na tabela
        int linhaSelecionada = jtbTabelaPaciente.getSelectedRow();

        //mostra as informações da linha selecionada na tabela na caixa de texto
        txtCodigoPaciente.setText(jtbTabelaPaciente.getValueAt(linhaSelecionada, 0).toString());
        txtNomePaciente.setText(jtbTabelaPaciente.getValueAt(linhaSelecionada, 1).toString());
        txtEndereco.setText(jtbTabelaPaciente.getValueAt(linhaSelecionada, 2).toString());
        txtComplemento.setText(jtbTabelaPaciente.getValueAt(linhaSelecionada, 3).toString());
        txtCpf.setText(jtbTabelaPaciente.getValueAt(linhaSelecionada, 4).toString());
        txtDataNascimento.setText(jtbTabelaPaciente.getValueAt(linhaSelecionada, 5).toString());
        txtRg.setText(jtbTabelaPaciente.getValueAt(linhaSelecionada, 6).toString());

    }//GEN-LAST:event_jtbTabelaPacienteMouseClicked
    ...
    private javax.swing.JTable jtbTabelaPaciente;
